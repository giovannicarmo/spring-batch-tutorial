...
import com.giovannicarmo.springbatchtutorial.writer.EmployeeWriter;
...
public class BatchConfiguration {
    ...
    @Bean
    public EmployeeWriter employeeXmlWritter() {
    ...
    public Step exportToXmlStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
            final ItemProcessor<Employee, WrappedItem<Employee, String>> processor) {
        return new StepBuilder("exportToXmlStep", jobRepository)
                .<Employee, WrappedItem<Employee, String>>chunk(10, transactionManager)
